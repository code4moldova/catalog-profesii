...
- Fixing typos.
- Improving docs.
- Triaging [issues](https://github.com/code4moldova/catalog-profesii/issues?q=is%3Aopen+is%3Aissue).
- Reviewing [pull requests](https://github.com/code4moldova/catalog-profesii/pulls?q=is%3Aopen+is%3Apr).
